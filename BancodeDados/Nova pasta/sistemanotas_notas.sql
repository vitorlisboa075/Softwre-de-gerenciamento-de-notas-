...
CREATE TABLE `notas` (
  ...
  KEY `fk_disciplina` (`disciplina_id`),
  CONSTRAINT `fk_disciplina` FOREIGN KEY (`disciplina_id`) REFERENCES `disciplinas` (`id`),
  CONSTRAINT `notas_ibfk_1` FOREIGN KEY (`turma_id`) REFERENCES `turmas` (`id`),
  CONSTRAINT `notas_ibfk_2` FOREIGN KEY (`aluno_cpf`) REFERENCES `alunos` (`cpf`)
...
INSERT INTO `notas` VALUES (12,30,'4678249290',NULL,6.00,8.00,9.00,6);
