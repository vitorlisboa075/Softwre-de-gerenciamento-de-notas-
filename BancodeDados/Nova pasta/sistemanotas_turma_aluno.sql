...
CREATE TABLE `turma_aluno` (
  ...
  KEY `turma_aluno_ibfk_2` (`aluno_cpf`),
  CONSTRAINT `turma_aluno_ibfk_1` FOREIGN KEY (`turma_id`) REFERENCES `turmas` (`id`),
  CONSTRAINT `turma_aluno_ibfk_2` FOREIGN KEY (`aluno_cpf`) REFERENCES `alunos` (`cpf`) ON DELETE CASCADE
...
INSERT INTO `turma_aluno` VALUES (73,30,'4678249290'),(74,30,'84932049843'),(75,30,'98763782789');
